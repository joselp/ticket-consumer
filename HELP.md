...
* The original package name 'com.jp.event.ticket-consumer' is invalid and this project uses 'com.jp.event.ticketconsumer' instead.
...
* [Spring for Apache ActiveMQ 5](https://docs.spring.io/spring-boot/docs/2.3.3.RELEASE/reference/htmlsingle/#boot-features-activemq)
